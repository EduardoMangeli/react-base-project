...
const Contato = () => {
    ...
    return (
        <Base>
            ...
            <div>
                <Botao texto={t("Entre em contato")} isWhatsApp={true} numeroCelular={"5521999929790"} mensagem={"Olá! Estou visitando o site e gostaria de mais informações sobre os serviços oferecidos."}></Botao>
            </div>
        </Base>
