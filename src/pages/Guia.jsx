...
const Guia = () => {
    ...
    return (
        <Base>  {/* Utiliza Base como um componente de ordem superior que envolve o conteúdo da página */}
            ...
            <div>
                <Botao texto={t("Entre em contato")} isWhatsApp={true} numeroCelular={"5521999929790"} mensagem={"Olá! Estou interessado(a) em me tornar um guia turístico. Poderiam fornecer mais informações sobre como posso me cadastrar?"}></Botao>
            </div>
        </Base>
    );
}
